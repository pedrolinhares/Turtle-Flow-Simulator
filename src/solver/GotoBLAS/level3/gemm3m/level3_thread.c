...
#ifndef KERNEL_FUNC
#ifdef XDOUBLE
#define KERNEL_FUNC	xgemm3m_kernel
#elif defined DOUBLE
#define KERNEL_FUNC	zgemm3m_kernel
#else
#define KERNEL_FUNC	cgemm3m_kernel
#endif
#endif
...
int CNAME(blas_arg_t *args, void *range_m, void *range_n, FLOAT *sa, FLOAT *sb, BLASLONG mypos){
  ...
  if (divN == 1){
    ...
    if (!blas_omp_linked) {
      ...
      gemm_thread_n(mode, args, range_m, range_n, GEMM3M_LOCAL, sa, sb, divN); 
    }
