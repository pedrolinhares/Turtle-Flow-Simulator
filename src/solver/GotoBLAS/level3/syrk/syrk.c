...
static int (*syrk[])(blas_arg_t *, void *, void *, FLOAT *, FLOAT *, BLASLONG) = {
#if defined(SMP) && !defined(USE_SIMPLE_THREADED_LEVEL3)
#ifdef XDOUBLE
    qsyrk_thread_UN, qsyrk_thread_UT, qsyrk_thread_LN, qsyrk_thread_LT,
#elif defined(DOUBLE)
    dsyrk_thread_UN, dsyrk_thread_UT, dsyrk_thread_LN, dsyrk_thread_LT,
#else
    ssyrk_thread_UN, ssyrk_thread_UT, ssyrk_thread_LN, ssyrk_thread_LT,
#endif
#else
#ifdef XDOUBLE
    qsyrk_UN, qsyrk_UT, qsyrk_LN, qsyrk_LT,
#elif defined(DOUBLE)
    dsyrk_UN, dsyrk_UT, dsyrk_LN, dsyrk_LT,
#else
    ssyrk_UN, ssyrk_UT, ssyrk_LN, ssyrk_LT,
#endif
#endif
};
...
int NAME(char *UPLO, char *TRANS,
 ...
 syrk_thread(mode, &args, NULL, NULL, (void *)syrk[(uplo<<1) | trans], sa, sb);
