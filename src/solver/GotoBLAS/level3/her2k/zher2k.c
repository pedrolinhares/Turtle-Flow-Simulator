...
static int (*her2k[])(blas_arg_t *, void *, void *, FLOAT *, FLOAT *) = {
#ifdef XDOUBLE
    xher2k_UN, xher2k_UC, xher2k_LN, xher2k_LC,
#elif defined(DOUBLE)
    zher2k_UN, zher2k_UC, zher2k_LN, zher2k_LC,
#else
    cher2k_UN, cher2k_UC, cher2k_LN, cher2k_LC,
#endif
};
...
int NAME(char *UPLO, char *TRANS,
  ...
  (her2k[(uplo << 1) | trans ])(&args, NULL, NULL, sa, sb);
 ...
 syrk_thread(mode, &args, NULL, NULL, (void *)her2k[(uplo<<1) | trans], sa, sb);
