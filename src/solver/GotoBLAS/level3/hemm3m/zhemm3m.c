...
static int (*hemm3m[])(blas_arg_t *, void *, void *, FLOAT *, FLOAT *, BLASLONG) = {
#if defined(SMP) && !defined(USE_SIMPLE_THREADED_LEVEL3)
#ifdef XDOUBLE
    xhemm3m_thread_LU, xhemm3m_thread_LL, xhemm3m_thread_RU, xhemm3m_thread_RL,
#elif defined(DOUBLE)
    zhemm3m_thread_LU, zhemm3m_thread_LL, zhemm3m_thread_RU, zhemm3m_thread_RL,
#else
    chemm3m_thread_LU, chemm3m_thread_LL, chemm3m_thread_RU, chemm3m_thread_RL,
#endif
#else
#ifdef XDOUBLE
    xhemm3m_LU, xhemm3m_LL, xhemm3m_RU, xhemm3m_RL,
#elif defined(DOUBLE)
    zhemm3m_LU, zhemm3m_LL, zhemm3m_RU, zhemm3m_RL,
#else
    chemm3m_LU, chemm3m_LL, chemm3m_RU, chemm3m_RL,
#endif
#endif
};
...
int NAME(char *SIDE, char *UPLO, 
...
#if !defined(SMP) || !defined(USE_SIMPLE_THREADED_LEVEL3)
  (hemm3m[(side << 1) | uplo ])(&args, NULL, NULL, sa, sb, 0);
#else
#ifdef XDOUBLE
  ...
  GEMM_THREAD(mode, &args, NULL, NULL, (void *)hemm3m[(side << 1) | uplo ], sa, sb, blas_cpu_number);
