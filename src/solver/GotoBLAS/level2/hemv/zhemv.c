...
static  int (*hemv[])(BLASLONG, FLOAT, FLOAT, FLOAT *, BLASLONG, FLOAT *, BLASLONG, FLOAT *, BLASLONG, FLOAT *) = {
#ifdef XDOUBLE
  xhemv_U, xhemv_L,
#elif defined(DOUBLE)
  zhemv_U, zhemv_L,
...
int NAME(char *UPLO, blasint *N, FLOAT  *ALPHA, FLOAT *a, blasint *LDA, 
...
#if 0
  fprintf(stderr, "ZHEMV : UPLO = %c  N = %3d  LDA = %3d, INCX = %3d INCY = %3d alpha = (%e, %e) beta = (%e, %e)\n",
	  *UPLO, n, lda, incx, incy, ALPHA[0], ALPHA[1], BETA[0], BETA[1]);
#endif  
  ...
  (hemv[uplo])(n, alpha_r, alpha_i, a, lda, b, incx, c, incy, buffer);
