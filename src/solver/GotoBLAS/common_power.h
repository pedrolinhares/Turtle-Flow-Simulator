...
#ifdef _AIX
  asm __volatile__(".machine \"any\" ;");
#endif
  asm __volatile__ ("mftb %0" : "=r" (ret) : );
...
#define GET_IMAGE(res)  asm __volatile__("fmr %0, 2" : "=f"(res)  : : "memory")
#else
#define GET_IMAGE(res)  asm __volatile__("fmr %0, f2" : "=f"(res)  : : "memory")
...
#if defined(POWER3) || defined(PPCG4) || defined(CELL)
#define DCBT_ARG	0
#else
#define DCBT_ARG	8
#endif

#if !defined(__APPLE__) || defined(NEEDPARAM)
#define f0	0
#define f1	1
#define f2	2
#define f3	3
